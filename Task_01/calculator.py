...
root = Tk()
root.title ("My Python Calclation")
root.geometry("360x381+500+200")
val=""
data=StringVar()
display=Entry(root,textvariable=data,bd=29,bg="powder blue",font=("ariel",20))
...
btn_eq=Button(root,text="=",font=("Ariel",12,"bold"),bd=12,height=2,width=6,command=btnEquals)
