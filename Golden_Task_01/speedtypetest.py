...
with open("C:\\Users\\HP\\Desktop\\Speed Typing Test Using Python\\typing_story.txt", "r") as file:
    allText = file.read()
...
root.title("Speed Typing Test Using Python")
root.resizable(0, 0)
bg_image = PhotoImage(file="C:\\Users\\HP\\Desktop\\Speed Typing Test Using Python\\background.png")
canvas = Canvas(root, width=1000, height=800)
canvas.pack(fill="both", expand=True)
canvas.create_image(0, 0, image=bg_image, anchor="nw")

# the heading or name of the the application
canvas.create_text(500, 20, text="Speed Typing Test Using Python", fill="white", font="raleway 20 bold")
canvas.pack()
...
# restart icon
restart_img = PhotoImage(file="C:\\Users\\HP\\Desktop\\Speed Typing Test Using Python\\restart-icon.png")
...
# delete icon
delete_img = PhotoImage(file="C:\\Users\\HP\\Desktop\\Speed Typing Test Using Python\\delete-icon.png")
